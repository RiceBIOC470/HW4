%HW4. Due 10/6/16 at 2:30pm.

% Note. You can use the code readIlastikFile.m to read the output from
% ilastik into MATLAB.
...
% The folder segmentationData has 5 very different images. Use
...
%% Problem 3. Tracking.
%this problem will be sent in a separate repository. Call your functions
%that answer the question here. 
